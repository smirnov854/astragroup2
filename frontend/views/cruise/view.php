...
$obj = json_decode($rrs);
//echo '<pre>'; print_r($obj->city->name_ru); echo '</pre>';
?>
    ...
    <div class="wrap clear">
        ...
        <div class="cart__top__wrap block__flex">
            <div class="card__left">
                <div class="card__left__photo card__left__photo__text" style="background-image: url('<?= @$obShip->src ? ($obShip->src) : "/i_ships/no-ship.png" ?>');">
                    <? if ($companyImage != null && $companyModel->company_type_id == 1) { ?>
                        <a class="card__left__photo__logo tooltip" title='Круизная компания "<?= $companyModel->name ?>"' target="_blank" href="https://astartagroup.ru/company/<?= $companyModel->ID ?>" style="background-image: url(<?= $companyImage ?>);"></a>
                    <? } ?>
                    <? if ($model->sale_text) { ?>
            ...
            <div class="card__right">
                <div class="card__right__top block__flex">
                    ...
                    <a href="#" class="card__right__top__link" onclick="$('.tabs__item.swiper-slide.reviews').click();" style="display: none;">Отзывы</a>
                    ...
                    <div>
                        ...
                        <div class="card__right__tur block__flex" style="margin-top: 20px;">
                            <? foreach ($listLoc as $loc) : ?>
                                <a href="#" style="color: #8f1416;" onclick="document.location.href='#loc-<?= $loc['Cabin_Loc_ID'] ?>'" class="card__right__tur__item cart-2 block__flex">
                                    <div class="card__right__tur__item__wrap block__flex">
                                        <div class="card__right__tur__item__img" style="background-image: url(<?= $loc['Image_Cabin_Group'] ? $loc['Image_Cabin_Group'] : '/apps/cabin/img/noimage.af01d7d3.jpg' ?>)"></div>
                                        <div class="card__right__tur__item__text">
                                            <div class="card__right__tur__item__title" style="overflow: auto;">
                                                <?= $loc['Name_Cabin_Loc'] ?>
                                            </div>
                                            <div>
                                                от <?= $loc['value'] . ' ' . $loc['currency'] ?>/чел.
                                            </div>
                                        </div>
                                    </div>
                                </a>
                ...
                <a href="#order-form" class="btn" id="scrollToForm">Оформить заказ</a>
            </div>
        </div>
                    ...
                    <div class="tabs__content__item">
                        <div class="ship__block">
                            <div class="ship__block__left">
                                    ...
                                    <div class="cart__slider__top--ship">
                                        <? foreach ($model->ship->gallery->images as $image) { ?>
                                            <div class="cart__slider__top__item">
                                                <img src="<?= $image->subdir . DIRECTORY_SEPARATOR . $image->name ?>" alt="">
                                            </div>
                                        <? } ?>
                                    </div>
                                ...
                                <? } else { ?>
                                    <img src="<?= @$obShip->name ? ($obShip->subdir . "/" . $obShip->name) : "/images/cart/cart.jpg" ?>" style="width: 500px;height: auto;">
                                <? } ?>
                            </div>
                    ...
                    <div class="tabs__content__item">
                        <div class="tabs__company__name">
                            <? if ( isset($companyImage) && $companyImage ) { ?>
                                <span class="tabs__company__name__img" style="background-image: url('<?= $companyImage ?>')"></span>
                            <? } else { ?>
                                <span class="tabs__company__name__img" style="background-image: url('/images/cart/Norwegian.svg')"></span>
                            <? } ?>
                        ...
                        <ul class="accordion viza__accordion">
                            <li class="viza__accordion__item" data-tab="1">
                                <div class="accordion__tittle">
                                    <div class="viza__accordion__icon" style="background-image: url(/images/cart/uk.png)"></div>
                            ...
                            <li class="viza__accordion__item" data-tab="1">
                                <div class="accordion__tittle">
                                    <div class="viza__accordion__icon" style="background-image: url('/images/cart/flag.png')"></div>
                                        ...
                                        <div class="cabina__wrap__left__inner__bottom">
                                            <div class="cabina__wrap__left__img">
                                                <a href="/images/lainer/cabina.png" data-fancybox>
                                                    <div class="cabina__wrap__left__img__wrap" style="background-image: url(/images/lainer/cabina.png);"></div>
                                                </a>
                                            </div>
                                    ...
                                    <div class="port__content__left">
                                        <div class="port__content__slider sticky-block">
                                            <div class="port__slider__top">
                                                <div class="cart__slider__top__item"><img src="/images/cart/slide-1.jpg" alt=""></div>
                                                <div class="cart__slider__top__item"><img src="/images/cart/slide-1.jpg" alt=""></div>
                                                <div class="cart__slider__top__item"><img src="/images/cart/slide-1.jpg" alt=""></div>
                                                <div class="cart__slider__top__item"><img src="/images/cart/slide-1.jpg" alt=""></div>
                                            </div>
                                            <div class="port__slider__bottom">
                                                <div class="cart__slider__bottom__item"><img src="/images/cart/slide-1.jpg" alt=""></div>
                                                <div class="cart__slider__bottom__item"><img src="/images/cart/slide-1.jpg" alt=""></div>
                                                <div class="cart__slider__bottom__item"><img src="/images/cart/slide-1.jpg" alt=""></div>
                                                <div class="cart__slider__bottom__item"><img src="/images/cart/slide-1.jpg" alt=""></div>
                                            </div>
            ...
            <div class="block__flex clear" id="order">
                <div class="cart__form__left">
                    <div class="cart__form__left__wrap">
                        ...
                        <div class="cart__form__title__small">Укажите пассажиров</div>
                        <div class="cart__form__select select-passengers">
                            ...
                            <div class="cart__select">
                                ...
                                <textarea style="display: none;" id="childrensListText"></textarea>
                                <ul id="childrensList"></ul>
                            </div>
                        </div>
                        <? /* <div style="display: none;" class="cart__form__select  block__flex">
                            <div class="cart__select  block__flex">
                                <div class="cart__label">Взрослые</div>
                                <div class="custom-select">
                                    <select name="ads" id="ads">
                        ...
                        <div class="cart__textarea">
                            <!-- <textarea style="display: none;" name="Order[comment]" id="comment" rows="5"></textarea> -->
                            ...
                            <textarea name="Order[comment]" id="comment" cols="30" rows="10" placeholder="Добавьте свой комментарий"></textarea>
                        </div>
                    ...
                    <div class="cart__form__left__wrap cart__form__left__wrap--right">
                        <div class="cart__check__table hidden">
                            <div class="cart__check">
                                <label>
                                    <input class="checkbox" type="checkbox" checked="checked" onclick='window.event.returnValue=false'>
                        ...
                        <div class="contact__form" style="">
                            ...
                            <input type="hidden" value="<?= $model->title ?>" id="cruiseName" name="cruiseName">
                            <input type="hidden" value="" id="cabin-code" name="Order[cabin]">
                            <input type="text" id="fio" name="Order[fio]" placeholder="Имя и Фамилия" class="contact__input">
                            <input type="tel" id="order-form-phone" name="Order[phone]" placeholder="Номер телефона" class="contact__input" maxlength="20">
                            <input type="email" id="order-form-email" name="Order[email]" placeholder="Email" class="contact__input">
                            <input type="hidden" id="order-form-address" name="Order[address]" class="contact__input" value="<?= $obj->city->name_ru ?>">
                            ...
                            <div class="politica">
                                <label>
                                    <input class="checkbox" checked type="checkbox" name="agreeMailing" id="agreeMailing">
                                    <span class="checkbox-custom"></span>
                                    <span class="label">Согласен на получение новостей и лучших предложений</span>
                                </label>
                            </div>
...
<? $script = <<< JS
	$('#scrollToForm').click(function(e) {
        e.preventDefault();
        $([document.documentElement,document.body]).animate({scrollTop:$("#order-form").offset().top}, 800)
    });

    $('.btn-control-block').click(function() {
        $('#comment').val('');
    });

    let childrens = [];
    $('#childrens').change(function(e) {
        ...
        // add to page
        $('#childrensList').append('<li class="select-passengers__li">'+value+'</li>');
        $('#childrensListText').val(childrens);
        
        //clear
        parent.find('.select-selected').text("Добавить ребенка");
        parent.find('.same-as-selected').removeClass("same-as-selected");
        $(this).val('');
    });

    $('#childrensList').click(function(e) {
        if(e.target.nodeName === "LI") {
            const idx = childrens.indexOf(e.target.outerText);
            if(idx >= 0) {
    ...
    $('.form__button__contact').click(function(e) {
	...
	$('#order-form').submit( function (e) {		
        ...
        let cabin = 'Даты/Круиз: ' + $('#cruiseName').val() + ' / ' + 'Каюта: ' + $('#orderList').text().substr(15);
        let childrensLength = 'Дети: ' + childrens.length;
		let cruise_id = $('#cruise_id').val();
		let phone = $('#order-form-phone').val();
		let email = $('#order-form-email').val();
		let fio = $('#fio').val();
		let comment = $('#comment').val();
        let address = $('#order-form-address').val();
		let ads = $('#ads option:selected').text() + ' / ' + childrensLength + ' (' + childrens + ')';
...
<div id="dialog-share" style="display: none">
    <div class="ya-share2" data-services="vkontakte,facebook,odnoklassniki,twitter,viber,whatsapp,skype,telegram" style="display: inline-block"></div>
    <a href="mailto:?subject=<?= $subject ?>&amp;&body=https://astartagroup.ru/cruise/<?= $model->ID ?>" title="Share by Email" style="
    line-height: 24px;
    font-size: 24px;
    width: 24px;
    height: 24px;
