...
<section class="page__menu">
	<div class="wrap">
		<div class="page__menu__wrap">
			<h1 class="page__menu__title">Автобусы и паромы</h1>
		...
		<ul class="cartblock cartblock--kruiz">	
			<li class="cartblock__item">
				<a href="" class="cartblock__link">
					<div class="cartblock__img" style="background-image: url(images/valaam.svg);"></div>
					<div class="cartblock__text">СПб-Хельсинки</div>
				</a>
			</li>
			<li class="cartblock__item">
				<a href="" class="cartblock__link">
					<div class="cartblock__img" style="background-image: url(images/zol.svg);"></div>
					<div class="cartblock__text">Таллин-Стокгольм-Хельсинки</div>
				</a>
			</li>
			<li class="cartblock__item">
				<a href="" class="cartblock__link">
					<div class="cartblock__img" style="background-image: url(images/kruiz_icon.svg);"></div>
					<div class="cartblock__text">Дания, Швеция, Норвегия</div>
				</a>
			</li>
			<li class="cartblock__item">
				<a href="" class="cartblock__link">
					<div class="cartblock__img" style="background-image: url(images/balt.svg);"></div>
					<div class="cartblock__text">Фьорды</div>
				</a>
			</li>
			<li class="cartblock__item">
				<a href="" class="cartblock__link">
					<div class="cartblock__img" style="background-image: url(images/spb.svg);"></div>
					<div class="cartblock__text">Туры в Прибалтику</div>
				</a>
			</li>
			<li class="cartblock__item">
				<a href="" class="cartblock__link">
					<div class="cartblock__img" style="background-image: url(images/valaam.svg);"></div>
					<div class="cartblock__text">Таллин-Рига-Стокгольм</div>
				</a>
			</li>
		</ul>
	</div>
...
<section class="kruiz__ship">
	<div class="wrap">
		...
		<ul class="cart block__flex">
			<li class="cart__item cart-4">
				<a href="" class="cart__link">
					<div class="cart__top">Принцесса Анастасия</div>
		...
		<li class="cart__item cart-4">
			<a href="" class="cart__link">
				<div class="cart__top">Tallink Silja</div>
	...
	<li class="cart__item cart-4">
		<a href="" class="cart__link">
			<div class="cart__top">Viking Line</div>
			<div class="cart__img"> <div class="cart__img__wrap" style="background-image: url(images/251d2b42e31a5f104383829d8130cb9e-min.jpg);"></div>
		</div>
	</a>
</li>
<li class="cart__item cart-4">
	<a href="" class="cart__link">
		<div class="cart__top">Паромы DFDS</div>
		<div class="cart__img"><div class="cart__img__wrap" style="background-image: url(images/251d2b42e31a5f104383829d8130cb9e-min.jpg);"></div>
	</div>
</a>
</li>
