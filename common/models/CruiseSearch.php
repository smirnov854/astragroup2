...
class CruiseSearch extends Cruise
{
    ...
    public function rules()
    {
        return [
            ...
            [[
                ...
                'types', 'regions', 'ports', 'countries', 'companies', 'ships', 'dep_ports', 'itn_ports', 'specials'
            ], 'safe'],
    ...
    public function silver_query($params)
    {
        ...
        //         $q->where('`cruise`.`region_id` in (' . implode(",", $this->regions) . ")");
        //     }]);
        // }
        ...
        if ($this->regions) {
            $query->andFilterWhere(['IN', 'cruise.region_id', $this->regions]);
        }
     ...
     * @return ActiveDataProvider
     */
    public function search_similar($params)
    {
        $query = self::silver_query($params);
        // print $query->createCommand()->rawSql;
        // die;
    ...
    {
        $cache = Yii::$app->cache;
        $key = 'regions' . md5(print_r($params, true));
        ...
        if ($result === false) {
            ...
            //echo '<!--Set Cache: regions -->';
        } else {
            //echo '<!--Use Cache: regions -->';
        }
    ...
    {
        $cache = Yii::$app->cache;
        $key = 'companies' . md5(print_r($params, true));
        ...
        if ($ar2 === false) {
            ...
            $cache->set($key, $ar2);
            //echo '<!--Set Cache: companies -->';
        } else {
            //echo '<!--Use Cache: companies -->';
        }
    ...
    {
        $cache = Yii::$app->cache;
        $key = 'countries' . md5(print_r($params, true));
        ...
        if ($ar2 === false) {
            ...
            $cache->set($key, $ar2);
            //echo '<!--Set Cache: countries -->';
        } else {
            //echo '<!--Use Cache: countries -->';
        }
    ...
    {
        $cache = Yii::$app->cache;
        $key = 'route_ports' . md5(print_r($params, true));
        ...
        if ($ar2 === false) {
            ...
            $cache->set($key, $ar2);
            //echo '<!--Set Cache: route_ports -->';
        } else {
            //echo '<!--Use Cache: route_ports -->';
        }
        return $ar2;
    ...
    {
        $cache = Yii::$app->cache;
        $key = 'deprt_ports' . md5(print_r($params, true));
        ...
        if ($ar2 === false) {
            ...
            $cache->set($key, $ar2);
            //echo '<!--Set Cache: deprt_ports -->';
        } else {
            //echo '<!--Use Cache: deprt_ports -->';
        }
    ...
    {
        $cache = Yii::$app->cache;
        $key = 'companyTypes' . md5(print_r($params, true));
        ...
        if ($result === false) {
            ...
            $result =
                ArrayHelper::map(CompanyType::findAll($type_ids), "ID", "name");

            $cache->set($key, $result);
            //echo '<!--Set Cache: companyTypes -->';
        } else {
            //echo '<!--Use Cache: companyTypes -->';
        }
    ...
    {
        $cache = Yii::$app->cache;
        $key = 'ships' . md5(print_r($params, true));
        ...
        if ($ar2 === false) {
            ...
            $cache->set($key, $ar2);
            //echo '<!--Set Cache: ships -->';
        } else {
            //echo '<!--Use Cache: ships -->';
        }
        return $ar2;
    ...
    {
        $cache = Yii::$app->cache;
        $key = 'dates' . md5(print_r($params, true));
        ...
        if ($result === false) {
            ...
            $cache->set($key, $result);
            //echo '<!--Set Cache: dates -->';
        } else {
            //echo '<!--Use Cache: dates -->';
        }
    ...
    {
        $cache = Yii::$app->cache;
        $key = 'lengs' . md5(print_r($params, true));
        ...
        if ($result === false) {
            ...
            $cache->set($key, $result);
            //echo '<!--Set Cache: lengs -->';
        } else {
            //echo '<!--Use Cache: lengs -->';
        }
    ...
    {
        $cache = Yii::$app->cache;
        $key = 'prices' . md5(print_r($params, true));
        ...
        if ($result === false) {
            ...
            $cache->set($key, $result);
            //echo '<!--Set Cache: prices -->';
        } else {
            //echo '<!--Use Cache: prices -->';
        }
    ...
    {
        $cache = Yii::$app->cache;
        $key = 'specials' . md5(print_r($params, true));
        ...
        if ($result === false) {
            ...
            $result =
                $specQuery->select("special.ID")->count();

            $cache->set($key, $result);
            //echo '<!--Set Cache: specials -->';
        } else {
            //echo '<!--Use Cache: specials -->';
        }
